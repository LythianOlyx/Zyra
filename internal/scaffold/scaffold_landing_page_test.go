...
func TestGenerate_LandingPageBuildsAsStandaloneModule(t *testing.T) {
	if testing.Short() {
	...
	dest := filepath.Join(t.TempDir(), "standalone-landing-page-app")
	res, err := Generate(Options{
		AppName:              "Standalone Landing App",
	...
	mustExist := []string{
		...
		"actions/contact.go", "actions/contact_test.go",
		"pages/index.tsx", "pages/blog/index.tsx", "pages/blog/[slug].tsx",
